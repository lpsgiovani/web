        ...
        <section className="bg-black text-white py-24 md:py-48 px-6 border-b border-white/10 relative overflow-hidden selection:bg-white selection:text-black">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div ref={containerRef} className="relative">
                    ...
                    {/* DESKTOP: Horizontal Circuit Line (Constrained Center-to-Center) */}
                    {/* Width calculation: Starts at center of col 1 (16.66%) and ends at center of col 3 (83.33%). Total width = 66.66% */}
                    <div className="hidden md:block absolute top-[50%] left-[16.66%] right-[16.66%] h-[1px] bg-zinc-800 overflow-hidden">
                        <motion.div
                            animate={{ x: ["-100%", "200%"] }}
                            transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
                            className="w-[50%] h-full bg-gradient-to-r from-transparent via-white to-transparent blur-[2px] opacity-80"
                        />
                    </div>
                    ...
                    {/* MOBILE: Vertical Timeline Line (Luz que desce no Scroll) */}
                    <motion.div
                        style={{ height: lineHeight }}
                        className="md:hidden absolute left-[21px] top-[7px] w-[1px] bg-gradient-to-b from-transparent via-white to-transparent opacity-80 z-10"
                    />
                        ...
                        {SERVICES.map((item, idx) => (
                            ...
                            >
                                ...
                                <div className="absolute left-[15px] md:left-1/2 md:-translate-x-1/2 top-1.5 md:top-1/2 md:-translate-y-1/2 z-20">
                                    ...
                                    <motion.div
                                        animate={{
                                            backgroundColor: ["rgba(0,0,0,1)", "rgba(255,255,255,1)", "rgba(0,0,0,1)"],
                                            scale: [1, 1.2, 1]
                                        }}
                                        transition={{
                                            duration: 3, // Matches line duration
                                            repeat: Infinity,
                                            delay: idx * 1.5, // 0s, 1.5s, 3.0s (Syncs with line progress 0%, 50%, 100%)
                                            ease: "easeInOut"
                                        }}
                                        className="w-3 h-3 border border-zinc-700 bg-black group-hover:border-white transition-colors duration-300"
                                    />
                                </div>

                                {/* Content: Title Area */}
                                <div
                                    className="pl-12 md:pl-0 md:pb-16 w-full md:text-center order-1 transition-all duration-500 md:group-hover:-translate-y-2"
                                >
                                ...
                                <div
                                    className="pl-12 md:pl-0 md:pt-16 w-full md:text-center order-2 transition-all duration-500 opacity-70 group-hover:opacity-100 md:group-hover:translate-y-2"
                                >
